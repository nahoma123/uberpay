insert  into casbin_rule values
                                 ...
                                 (7,'p','SUPER-ADMIN|COMPANY-ADMIN','/companies/:company-id/users','read'),
                                 (8,'p','SUPER-ADMIN|COMPANY-ADMIN','/companies/:company-id/user','read'),
                                 (9,'p','SUPER-ADMIN | COMPANY-ADMIN','/companies/:company-id/users/:user-id','delete'),
                                 (10,'p','SUPER-ADMIN | COMPANY-ADMIN','/companies/:company-id/add-users','create'),
